...
class HPXMLtoHEScoreTranslator(object):
    ...
    def _get_building_zone_wall(self, b, bldg_about):
        ...
        wall_eff_rvalues['ps'] = dict(zip(wall_ext_finish_types[:-1], [dict(zip((0, 3, 7, 11, 13, 15, 19, 21), x))
                                                                       for x in [(9.6, 12.0, 14.9, 17.1, 19.1, 21.1, 25.1, 27.1),
                                                                                 (8.3, 10.9, 13.5, 16.4, 18.4, 20.4, 24.4, 26.4),
                                                                                 (8.9, 11.4, 14.1, 16.3, 18.3, 20.3, 24.3, 26.3),
                                                                                 (8.8, 11.2, 14.1, 16.2, 18.2, 20.2, 24.2, 26.2),
                                                                                 (9.7, 12.2, 14.9, 17.0, 19.0, 21.0, 25.0, 27.0)]]))
