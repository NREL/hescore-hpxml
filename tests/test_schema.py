...
def test_invalid_building_about(hpxml_filebase):
    ...
    js1_about = copy.deepcopy(js['building_unit']['about'])
    del js1['building_unit']['about']
    js1['building_unit']['about'] = []
    js1['building_unit']['about'].append(js1_about)
    js1['building_unit']['about'].append(js1_about)
    errors = get_error_messages(js1, js_schema)
    if hpxml_filebase == 'townhouse_walls':
        assert any(error.find("'shape': 'town_house'") > -1 and
                   error.endswith("is not of type 'object'") for error in errors)
    elif hpxml_filebase == 'house1':
        assert any(error.find("'shape': 'rectangle'") > -1 and
                   error.endswith("is not of type 'object'") for error in errors)

    js2 = copy.deepcopy(js)
    if hpxml_filebase == 'townhouse_walls':
        del js2['building_unit']['about']['envelope_leakage']
        ...
        js2['building_unit']['about']['blower_door_test'] = False
        errors = get_error_messages(js2, js_schema)
        assert "'air_sealing_present' is a required property" in errors
    elif hpxml_filebase == 'house1':
        del js2['building_unit']['about']['air_sealing_present']
        errors = get_error_messages(js2, js_schema)
        assert "'envelope_leakage' is a required property" not in errors
        assert "'air_sealing_present' is a required property" in errors
    del js2['building_unit']['about']['assessment_date']
    del js2['building_unit']['about']['shape']
    del js2['building_unit']['about']['year_built']
    del js2['building_unit']['about']['number_bedrooms']
    del js2['building_unit']['about']['num_floor_above_grade']
    del js2['building_unit']['about']['floor_to_ceiling_height']
    del js2['building_unit']['about']['conditioned_floor_area']
    del js2['building_unit']['about']['orientation']
    del js2['building_unit']['about']['blower_door_test']
    errors = get_error_messages(js2, js_schema)
...
def test_invalid_building_zone(hpxml_filebase):
    ...
    js_schema = jsonschema.Draft7Validator(schema, format_checker=jsonschema.FormatChecker())
    js = get_example_json(hpxml_filebase)
    zone = copy.deepcopy(js['building_unit']['zone'])
    del js['building_unit']['zone']
    js['building_unit']['zone'] = []
    js['building_unit']['zone'].append(zone)
    js['building_unit']['zone'].append(zone)
    errors = get_error_messages(js, js_schema)
    if hpxml_filebase == 'townhouse_walls':
...
def test_invalid_roof(hpxml_filebase):
    ...
    js1 = copy.deepcopy(js)
    del js1['building_unit']['zone']['zone_roof'][0]['roof_assembly_code']
    del js1['building_unit']['zone']['zone_roof'][0]['roof_color']
    del js1['building_unit']['zone']['zone_roof'][0]['roof_type']
    del js1['building_unit']['zone']['zone_roof'][0]['ceiling_assembly_code']
    errors = get_error_messages(js1, js_schema)
    ...
    js2 = copy.deepcopy(js)
    js2['building_unit']['zone']['zone_roof'][0]['roof_type'] = 'cath_ceiling'
    js2['building_unit']['zone']['zone_roof'][0]['roof_absorptance'] = 0.6
    errors = get_error_messages(js2, js_schema)
...
def test_invalid_skylight():
    ...
    js1 = copy.deepcopy(js)
    js1['building_unit']['zone']['zone_roof'][0]['zone_skylight']['skylight_method'] = 'custom'
    errors = get_error_messages(js1, js_schema)
    ...
    del js1['building_unit']['zone']['zone_roof'][0]['zone_skylight']['skylight_method']
    del js1['building_unit']['zone']['zone_roof'][0]['zone_skylight']['skylight_code']
    errors = get_error_messages(js1, js_schema)
    ...
    js2 = copy.deepcopy(js)
    js2['building_unit']['zone']['zone_roof'][0]['zone_skylight']['skylight_area'] = 0
    del js2['building_unit']['zone']['zone_roof'][0]['zone_skylight']['skylight_method']
    errors = get_error_messages(js2, js_schema)
    assert "'skylight_method' is a required property" not in errors

    js3 = copy.deepcopy(js)
    js3['building_unit']['zone']['zone_roof'][0]['zone_skylight']['skylight_u_value'] = 0.5
    errors = get_error_messages(js3, js_schema)
...
def test_invalid_floor(hpxml_filebase):
    ...
    js1 = copy.deepcopy(js)
    del js1['building_unit']['zone']['zone_floor'][0]['foundation_type']
    del js1['building_unit']['zone']['zone_floor'][0]['foundation_insulation_level']
    errors = get_error_messages(js1, js_schema)
    ...
    del js1['building_unit']['zone']['zone_floor'][0]['floor_area']
    del js1['building_unit']['zone']['zone_floor'][0]['floor_assembly_code']
    errors = get_error_messages(js1, js_schema)
    ...
    js2 = copy.deepcopy(js)
    js2['building_unit']['zone']['zone_floor'][0]['foundation_type'] = 'slab_on_grade'
    errors = get_error_messages(js2, js_schema)
    if hpxml_filebase == 'townhouse_walls':
...
def test_invalid_wall_window_construction_same(hpxml_filebase):
    ...
    js_schema = jsonschema.Draft7Validator(schema, format_checker=jsonschema.FormatChecker())
    js = get_example_json(hpxml_filebase)
    del js['building_unit']['zone']['wall_construction_same']
    del js['building_unit']['zone']['window_construction_same']
    errors = get_error_messages(js, js_schema)
...
def test_invalid_wall(hpxml_filebase):
    ...
    js1 = copy.deepcopy(js)
    del js1['building_unit']['zone']['zone_wall'][0]['side']
    del js1['building_unit']['zone']['zone_wall'][1]['wall_assembly_code']
    errors = get_error_messages(js1, js_schema)
    ...
    js2 = copy.deepcopy(js)
    js2['building_unit']['zone']['wall_construction_same'] = True
    del js2['building_unit']['zone']['zone_wall'][1]['wall_assembly_code']
    errors = get_error_messages(js2, js_schema)
    if hpxml_filebase == 'townhouse_walls':
    ...
    if hpxml_filebase == 'townhouse_walls':
        js3 = copy.deepcopy(js)
        js3['building_unit']['zone']['zone_wall'].append({'side': 'right'})
        errors = get_error_messages(js3, js_schema)
...
def test_invalid_window(hpxml_filebase):
    ...
    js1 = copy.deepcopy(js)
    if hpxml_filebase == 'townhouse_walls':
        del js1['building_unit']['zone']['zone_wall'][0]['zone_window']['window_u_value']
    del js1['building_unit']['zone']['zone_wall'][0]['zone_window']['window_area']
    del js1['building_unit']['zone']['zone_wall'][2]['zone_window']['window_code']
    errors = get_error_messages(js1, js_schema)
    if hpxml_filebase == 'townhouse_walls':
        ...
        assert 'zone_wall/side["front"]/zone_window requires "window_area" and "window_method"' in errors
        assert 'zone_wall/side["back"]/zone_window requires "window_code"' in errors
    del js1['building_unit']['zone']['zone_wall'][2]['zone_window']['window_method']
    errors = get_error_messages(js1, js_schema)
    assert 'zone_wall/side["back"]/zone_window requires "window_area" and "window_method"' in errors
    js1['building_unit']['zone']['zone_wall'][0]['zone_window']['window_shgc'] = 1
    errors = get_error_messages(js1, js_schema)
    assert '1 is greater than or equal to the maximum of 1' in errors

    js2 = copy.deepcopy(js)
    js2['building_unit']['zone']['zone_wall'][0]['zone_window']['window_u_value'] = 0.5
    errors = get_error_messages(js2, js_schema)
    if hpxml_filebase == 'townhouse_walls':
        assert len(errors) == 0
    elif hpxml_filebase == 'house1':
    ...
    js3 = copy.deepcopy(js)
    js3['building_unit']['zone']['zone_wall'][0]['zone_window']['window_code'] = 'dcaa'
    errors = get_error_messages(js3, js_schema)
    if hpxml_filebase == 'townhouse_walls':
...
def test_invalid_heating(hpxml_filebase):
    ...
    js1 = copy.deepcopy(js)
    del js1['building_unit']['systems']['hvac'][0]['hvac_name']
    errors = get_error_messages(js1, js_schema)
    assert "'hvac_name' is a required property" in errors

    js2 = copy.deepcopy(js)
    js2['building_unit']['systems']['hvac'][0]['heating']['type'] = 'none'
    del js2['building_unit']['systems']['hvac'][0]['heating']['fuel_primary']
    del js2['building_unit']['systems']['hvac'][0]['heating']['efficiency_method']
    errors = get_error_messages(js2, js_schema)
    assert len(errors) == 0
    del js2['building_unit']['systems']['hvac'][0]['heating']['type']
    errors = get_error_messages(js2, js_schema)
    assert "'type' is a required property" in errors

    js3 = copy.deepcopy(js)
    # natural gas central furnace
    del js3['building_unit']['systems']['hvac'][0]['heating']['efficiency']
    errors = get_error_messages(js3, js_schema)
    assert "'efficiency' is a required property" in errors
    del js3['building_unit']['systems']['hvac'][0]['heating']['efficiency_method']
    errors = get_error_messages(js3, js_schema)
    assert "'efficiency_method' is a required property" in errors
    js3['building_unit']['systems']['hvac'][0]['heating']['efficiency_method'] = 'shipment_weighted'
    errors = get_error_messages(js3, js_schema)
    assert "'year' is a required property" in errors
    js3['building_unit']['systems']['hvac'][0]['heating']['efficiency'] = 0.5
    errors = get_error_messages(js3, js_schema)
    ...
    del js3['building_unit']['systems']['hvac'][0]['heating']['fuel_primary']
    errors = get_error_messages(js3, js_schema)
    assert "'fuel_primary' is a required property" in errors
    # electric central furnace
    js3['building_unit']['systems']['hvac'][0]['heating']['fuel_primary'] = 'electric'
    errors = get_error_messages(js3, js_schema)
    assert len(errors) == 0
    # electric wall furnace
    js3['building_unit']['systems']['hvac'][0]['heating']['type'] = 'wall_furnace'
    del js3['building_unit']['systems']['hvac'][0]['heating']['efficiency']
    errors = get_error_messages(js3, js_schema)
    assert len(errors) == 0
    # electric boiler
    js3['building_unit']['systems']['hvac'][0]['heating']['type'] = 'boiler'
    errors = get_error_messages(js3, js_schema)
    assert len(errors) == 0
    # heat pump
    js3['building_unit']['systems']['hvac'][0]['heating']['type'] = 'heat_pump'
    js3['building_unit']['systems']['hvac'][0]['heating']['efficiency'] = 1.1
    errors = get_error_messages(js3, js_schema)
    assert "1.1 is less than the minimum of 6" in errors
    # mini-split
    js3['building_unit']['systems']['hvac'][0]['heating']['type'] = 'mini_split'
    js3['building_unit']['systems']['hvac'][0]['heating']['efficiency'] = 20.1
    errors = get_error_messages(js3, js_schema)
    assert "20.1 is greater than the maximum of 20" in errors
    # gchp
    js3['building_unit']['systems']['hvac'][0]['heating']['type'] = 'gchp'
    errors = get_error_messages(js3, js_schema)
    assert "20.1 is greater than the maximum of 5" in errors
    # electric baseboard
    js3['building_unit']['systems']['hvac'][0]['heating']['type'] = 'baseboard'
    errors = get_error_messages(js3, js_schema)
    assert len(errors) == 0
    # electric wood stove
    js3['building_unit']['systems']['hvac'][0]['heating']['type'] = 'wood_stove'
    errors = get_error_messages(js3, js_schema)
    assert len(errors) == 0
    # natural gas wood stove
    js3['building_unit']['systems']['hvac'][0]['heating']['fuel_primary'] = 'natural_gas'
    errors = get_error_messages(js3, js_schema)
    assert len(errors) == 0

    js4 = copy.deepcopy(js)
    del js4['building_unit']['systems']['hvac'][0]['hvac_fraction']
    errors = get_error_messages(js4, js_schema)
    assert "'hvac_fraction' is a required property" in errors

    js5 = copy.deepcopy(js)
    js5['building_unit']['systems']['hvac'][0]['heating']['year'] = 2021
...
def test_invalid_cooling(hpxml_filebase):
    ...
    js1 = copy.deepcopy(js)
    del js1['building_unit']['systems']['hvac'][0]['hvac_name']
    js1['building_unit']['systems']['hvac'][0]['cooling']['year'] = 2021
    errors = get_error_messages(js1, js_schema)
    assert "'hvac_name' is a required property" in errors
    ...
    js2 = copy.deepcopy(js)
    js2['building_unit']['systems']['hvac'][0]['cooling']['type'] = 'none'
    del js2['building_unit']['systems']['hvac'][0]['cooling']['efficiency_method']
    errors = get_error_messages(js2, js_schema)
    assert len(errors) == 0
    del js2['building_unit']['systems']['hvac'][0]['cooling']['type']
    errors = get_error_messages(js2, js_schema)
    assert "'type' is a required property" in errors

    js3 = copy.deepcopy(js)
    # split dx
    del js3['building_unit']['systems']['hvac'][0]['cooling']['efficiency']
    errors = get_error_messages(js3, js_schema)
    assert "'efficiency' is a required property" in errors
    del js3['building_unit']['systems']['hvac'][0]['cooling']['efficiency_method']
    errors = get_error_messages(js3, js_schema)
    assert "'efficiency_method' is a required property" in errors
    js3['building_unit']['systems']['hvac'][0]['cooling']['efficiency_method'] = 'shipment_weighted'
    errors = get_error_messages(js3, js_schema)
    assert "'year' is a required property" in errors
    js3['building_unit']['systems']['hvac'][0]['cooling']['efficiency'] = 7.9
    errors = get_error_messages(js3, js_schema)
    ...
    # heat pump
    js3['building_unit']['systems']['hvac'][0]['cooling']['type'] = 'heat_pump'
    errors = get_error_messages(js3, js_schema)
    assert "7.9 is less than the minimum of 8" in errors
    # packaged dx
    js3['building_unit']['systems']['hvac'][0]['cooling']['type'] = 'packaged_dx'
    js3['building_unit']['systems']['hvac'][0]['cooling']['efficiency'] = 40.1
    errors = get_error_messages(js3, js_schema)
    assert "40.1 is greater than the maximum of 40" in errors
    # mini-split
    js3['building_unit']['systems']['hvac'][0]['cooling']['type'] = 'mini_split'
    errors = get_error_messages(js3, js_schema)
    assert "40.1 is greater than the maximum of 40" in errors
    # gchp
    js3['building_unit']['systems']['hvac'][0]['cooling']['efficiency'] = 40.1
    js3['building_unit']['systems']['hvac'][0]['cooling']['type'] = 'gchp'
    errors = get_error_messages(js3, js_schema)
    assert "40.1 is greater than the maximum of 40" in errors
    # dec
    js3['building_unit']['systems']['hvac'][0]['cooling']['type'] = 'dec'
    errors = get_error_messages(js3, js_schema)
    assert len(errors) == 0
...
def test_invalid_hvac_distribution(hpxml_filebase):
    ...
    js1 = copy.deepcopy(js)
    js1['building_unit']['systems']['hvac'][0]['heating']['type'] = 'wall_furnace'
    js1['building_unit']['systems']['hvac'][0]['cooling']['type'] = 'packaged_dx'
    del js1['building_unit']['systems']['hvac'][0]['hvac_distribution']['duct'][0]['location']
    del js1['building_unit']['systems']['hvac'][0]['hvac_distribution']['duct'][0]['insulated']
    errors = get_error_messages(js1, js_schema)
    if hpxml_filebase == 'townhouse_walls':
    ...
    js2 = copy.deepcopy(js)
    del js2['building_unit']['systems']['hvac'][0]['hvac_distribution']['duct'][0]['name']
    del js2['building_unit']['systems']['hvac'][0]['hvac_distribution']['duct'][0]['location']
    del js2['building_unit']['systems']['hvac'][0]['hvac_distribution']['duct'][0]['insulated']
    errors = get_error_messages(js2, js_schema)
    ...
    del js2['building_unit']['systems']['hvac'][0]['hvac_distribution']['duct'][0]['fraction']
    errors = get_error_messages(js2, js_schema)
    ...
    js3 = copy.deepcopy(js)
    del js3['building_unit']['systems']['hvac'][0]['hvac_distribution']
    errors = get_error_messages(js3, js_schema)
    assert "'hvac_distribution' is a required property" in errors
    js3['building_unit']['systems']['hvac'][0]['hvac_fraction'] = 0
    errors = get_error_messages(js3, js_schema)
    assert "'hvac_distribution' is a required property" in errors
    js3['building_unit']['systems']['hvac'][0]['hvac_fraction'] = 1
    js3['building_unit']['systems']['hvac'][0]['heating']['type'] = 'mini_split'
    js3['building_unit']['systems']['hvac'][0]['heating']['efficiency'] = 6
    js3['building_unit']['systems']['hvac'][0]['cooling']['type'] = 'packaged_dx'
    errors = get_error_messages(js3, js_schema)
    assert len(errors) == 0

    js4 = copy.deepcopy(js)
    del js4['building_unit']['systems']['hvac'][0]['hvac_distribution']['leakage_method']
    errors = get_error_messages(js4, js_schema)
    assert "'leakage_method' is a required property" in errors
    js4['building_unit']['systems']['hvac'][0]['hvac_distribution']['leakage_method'] = 'quantitative'
    errors = get_error_messages(js4, js_schema)
    ...
    js5 = copy.deepcopy(js)
    del js5['building_unit']['systems']['hvac'][0]['hvac_distribution']['sealed']
    errors = get_error_messages(js5, js_schema)
...
def test_invalid_duct_location(hpxml_filebase):
    ...
    js1 = copy.deepcopy(js)
    js1['building_unit']['zone']['zone_roof'][0]['roof_type'] = "cath_ceiling"
    js1['building_unit']['systems']['hvac'][0]['hvac_distribution']['duct'][0]['location'] = "uncond_attic"
    errors = get_error_messages(js1, js_schema)
...
def test_invalid_domestic_hot_water(hpxml_filebase):
    ...
    js1 = copy.deepcopy(js)
    del js1['building_unit']['systems']['domestic_hot_water']['category']
    del js1['building_unit']['systems']['domestic_hot_water']['efficiency_method']
    errors = get_error_messages(js1, js_schema)
    assert "'category' is a required property" in errors
    assert "'efficiency_method' is a required property" not in errors

    js2 = copy.deepcopy(js)
    del js2['building_unit']['systems']['domestic_hot_water']['efficiency_method']
    errors = get_error_messages(js2, js_schema)
    assert "'efficiency_method' is a required property" in errors

    js3 = copy.deepcopy(js)
    del js3['building_unit']['systems']['domestic_hot_water']['type']
    del js3['building_unit']['systems']['domestic_hot_water']['fuel_primary']
    errors = get_error_messages(js3, js_schema)
    assert "'type' is a required property" in errors
    assert "'fuel_primary' is a required property" in errors
    if hpxml_filebase == 'townhouse_walls':
        del js3['building_unit']['systems']['domestic_hot_water']['year']
        errors = get_error_messages(js3, js_schema)
        assert "'year' is a required property" in errors
    elif hpxml_filebase == 'house1':
        del js3['building_unit']['systems']['domestic_hot_water']['energy_factor']
        errors = get_error_messages(js3, js_schema)
        assert "'energy_factor' is a required property" in errors
        js3['building_unit']['systems']['domestic_hot_water']['category'] = 'combined'
        errors = get_error_messages(js3, js_schema)
    ...
    js4 = copy.deepcopy(js)
    js4['building_unit']['systems']['domestic_hot_water']['energy_factor'] = 0.44
    errors = get_error_messages(js4, js_schema)
    assert "0.44 is less than the minimum of 0.45" in errors
    js4['building_unit']['systems']['domestic_hot_water']['type'] = 'tankless'
    errors = get_error_messages(js4, js_schema)
    if hpxml_filebase == 'townhouse_walls':
        js4['building_unit']['systems']['domestic_hot_water']['efficiency_method'] = 'user'
        del js4['building_unit']['systems']['domestic_hot_water']['year']
    errors = get_error_messages(js4, js_schema)
    assert "0.44 is less than the minimum of 0.45" in errors
    js4['building_unit']['systems']['domestic_hot_water']['type'] = 'heat_pump'
    js4['building_unit']['systems']['domestic_hot_water']['energy_factor'] = 4.1
    errors = get_error_messages(js4, js_schema)
    assert any(x.startswith("4.1 is greater than the maximum") for x in errors)
    js4['building_unit']['systems']['domestic_hot_water']['type'] = 'indirect'
    errors = get_error_messages(js4, js_schema)
    assert "'combined' was expected" in errors

    js5 = copy.deepcopy(js)
    js5['building_unit']['systems']['domestic_hot_water']['fuel_primary'] = 'natural_gas'
    js5['building_unit']['systems']['domestic_hot_water']['energy_factor'] = 0.96
    errors = get_error_messages(js5, js_schema)
    assert "0.96 is greater than the maximum of 0.95" in errors
    js5['building_unit']['systems']['domestic_hot_water']['type'] = 'tankless'
    js5['building_unit']['systems']['domestic_hot_water']['energy_factor'] = 1.0
    if hpxml_filebase == 'townhouse_walls':
        js5['building_unit']['systems']['domestic_hot_water']['efficiency_method'] = 'user'
        del js5['building_unit']['systems']['domestic_hot_water']['year']
    errors = get_error_messages(js5, js_schema)
    assert "1.0 is greater than the maximum of 0.99" in errors

    js6 = copy.deepcopy(js)
    if hpxml_filebase == 'townhouse_walls':
        js6['building_unit']['systems']['domestic_hot_water']['energy_factor'] = 0.6
        ...
        js6['building_unit']['systems']['domestic_hot_water']['year'] = 2021
        errors = get_error_messages(js6, js_schema)
...
def test_invalid_solar_electric(hpxml_filebase):
    ...
    js1 = copy.deepcopy(js)
    js1['building_unit']['systems'] = {'generation': {'solar_electric': {'capacity_known': False, 'system_capacity': 50}}}
    errors = get_error_messages(js1, js_schema)
    ...
    js2 = copy.deepcopy(js)
    js2['building_unit']['systems'] = {'generation': {'solar_electric': {'capacity_known': True, 'num_panels': 5}}}
    errors = get_error_messages(js2, js_schema)
    ...
    js3 = copy.deepcopy(js)
    js3['building_unit']['systems'] = {'generation': {'solar_electric': {'year': 2021}}}
    errors = get_error_messages(js3, js_schema)
